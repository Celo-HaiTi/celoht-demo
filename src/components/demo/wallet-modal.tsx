...
const PROVIDERS: {
...
}[] = [
  {
    id: "minipay",
    name: "MiniPay",
    logo: "/brand/minipay-logo.png",
    note: "Use MiniPay when this dApp is opened inside MiniPay",
  },
  {
    id: "valora",
    name: "Valora",
    logo: "/brand/valora-logo.png",
    note: "Connect through WalletConnect",
  },
  {
    id: "walletconnect",
    name: "Other wallets",
    note: "Connect any compatible WalletConnect wallet",
  },
];
              ...
              <div>
                ...
                {!connected && (
                  <p className="mt-1 text-xs text-navy-900/50">
                    CeloHT supports multiple compatible wallet options.
                  </p>
                )}
              </div>
              ...
              <div>
                <div className="flex items-center gap-3 rounded-xl bg-green-100 p-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="tabular truncate text-xs text-navy-900/60">
                      {address ? truncateHash(address, 6) : ""}
                    </p>
                  </div>
                </div>

                <p className="mt-3 text-xs text-navy-900/50">
                  Simulated connection for demo purposes. No real wallet was
                  accessed.
                </p>
              ...
              <div className="space-y-2">
                {PROVIDERS.map((p) => (
                  ...
                  >
                    ...
                    {connecting && (
                      <Loader2 className="h-4 w-4 animate-spin text-navy-900/40" />
                    )}
                  </button>
                ))}

                <p className="pt-2 text-center text-xs text-navy-900/40">
                  CeloHT never requests your private key, seed phrase, or
                  wallet password.
                </p>
              </div>
            )}
