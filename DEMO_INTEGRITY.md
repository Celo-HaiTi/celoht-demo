...
| MiniPay | Shown in the wallet modal per the design brief, but CeloHT's real, documented wallet policy is Valora-only | Tagged "Coming soon" plus "Not yet officially supported" in the modal |
...
1. Say out loud, at the start of the walkthrough, that this is a demo of the intended experience, not the live product. Do not rely on the in-app banners alone to carry that context in a live presentation.
